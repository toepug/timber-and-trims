...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch about a custom order, repair, or general question -- tell us about the wood, frame color, and details you have in mind.",
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <p className="mt-4 text-lg leading-relaxed text-ink-muted">
        ...
        materials and fit, send us a note. We read every message and reply
        ourselves.
      </p>
